...
class UpdateTransactionView(TransactionMixin, APIView):

    @method_decorator(csrf_exempt)
    def dispatch(self, request, *args, **kwargs):
        return super(UpdateTransactionView, self).dispatch(request, *args, **kwargs)
    ...
    def post(request, *args, **kwargs):
        ...
        validated_request_body = SubscriptionViewHelper.update_transaction_body_validator(request_body, user_id)
        ...
        subscription_manager = SubscriptionImpl()
        response_data = subscription_manager.update_transaction(validated_request_body['payment_id'], user_id)
...
class CreateSubscriptionView(TransactionMixin, APIView):
    ...
    def post(request, *args, **kwargs):
        ...
        subscription_manager = SubscriptionImpl()
        response_data = subscription_manager.create_subscription(validated_request_body['payment_id'])
