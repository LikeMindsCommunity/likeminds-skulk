...
KETTLE_SERVICE_URL = os.getenv("PRODUCTION_KETTLE_URL")
...
RAZORPAY_X_ACCOUNT_NUMBER = os.getenv("PRODUCTION_RAZORPAY_X_ACCOUNT_NUMBER")
RAZORPAY_X_WEBHOOK_SECRET = os.getenv("PRODUCTION_RAZORPAY_X_WEBHOOK_SECRET")
